...
ploticus                      # Scriptable plotting and graphing utility
...
stanford-ner                  # Stanford NLP Group's implementation of a Named Entity Recognizer
stash-cli                     # Command-line interface clients for Atlassian products
