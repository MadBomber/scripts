...
###
##  File: Brewfile
##  Desc: A list of homebrew-managed packages for MacOS
#
...
bigloo                        # Scheme implementation with object system, C, and Java interf
...
fping                         # Scriptable ping program for checking if multiple hosts are u
...
madbomber/brews/justprep      # Pre-processor to the 'just' command-line utility
...
mist                          # Mac command-line tool that automatically downloads macOS Firmwares / Installers
mkdocs                        # Project documentation with Markdown
mold                          # Modern Linker
monit                         # Manage and monitor processes, files, directories, and device
...
rustc-completion              # Bash completion for rustc
...
xo/xo/usql                    # universal command-line SQL client interface
